...
export class Backend implements backendInterface {
    ...
    async addVehicle(arg0: VehicleType, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: ExternalBlob | null, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addVehicle(to_candid_VehicleType_n8(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3, arg4, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg5), arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_VehicleType_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VehicleType): VehicleType {
...
async function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        model: value.model,
        vehicleType: from_candid_VehicleType_n17(_uploadFile, _downloadFile, value.vehicleType),
        owner: value.owner,
        year: value.year,
...
function from_candid_variant_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "bike" in value ? VehicleType.bike : "scooty" in value ? VehicleType.scooty : "electric" in value ? VehicleType.electric : value;
}
...
function to_candid_VehicleType_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: VehicleType): _VehicleType {
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: VehicleType): {
    bike: null;
} | {
    scooty: null;
} | {
    ...
    return value == VehicleType.bike ? {
        bike: null
    } : value == VehicleType.scooty ? {
        scooty: null
